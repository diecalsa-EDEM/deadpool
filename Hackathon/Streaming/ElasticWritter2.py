...
class processTraficData(beam.DoFn):
    ...
    def process(self, element):
        ...
        #Bucle para conversión de coordenadas
        for i in coord:
...
class processValenbisiData(beam.DoFn):
    """
...
class IndexValenbisiDocument(beam.DoFn):
...
def run_valenbisi(argv=None, save_main_session=True):
  """Main entry point; defines and runs the wordcount pipeline."""
  valenbisi_parser = argparse.ArgumentParser()
  
  #1 Replace your hackathon-edem with your project id 
  valenbisi_parser.add_argument('--input_topic',
                      dest='input_topic',
                      #1 Add your project Id and topic name you created
                      # Example projects/versatile-gist-251107/topics/iexCloud',
                      default='projects/hackathon-diego/topics/valenbisi',
                      help='Input file to process.')
  #2 Replace your hackathon-edem with your project id 
  valenbisi_parser.add_argument('--input_subscription',
                      ...
                      default='projects/hackathon-diego/subscriptions/streaming',
                      help='Input Subscription')
  
    
  known_args, pipeline_args = valenbisi_parser.parse_known_args(argv)
  ...
  biciStations = ( biciStations | beam.ParDo(processValenbisiData()))
  
  biciStations | 'Print Quote' >> beam.Map(print)
  
  # Store messages on elastic
  biciStations | 'Bici Stations Stored' >> beam.ParDo(IndexValenbisiDocument())
